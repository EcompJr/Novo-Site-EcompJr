jQuery(document).ready(function ($) {
  ...
  $('#send_message').click(function (e) {
    ...
    var jw_guia = $('#guia').val();
    var jw_message = $('#message').val();
    var jw_about = $('#about').val();
    ...
    if (jw_guia.length == 0) {
      var error = true;
      $('#guia_error').fadeIn(500);
    } else {
      $('#guia_error').fadeOut(500);
    }
    ...
    if (jw_about.length == 0) {
      var error = true;
      $('#about_error').fadeIn(500);
    } else {
      $('#about_error').fadeOut(500);
    }
