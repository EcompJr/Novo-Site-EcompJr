  jQuery(window).load(function(){
    ...
    $('#member-0').html('<div class="inner-container"><img src="'+members[0].image+'" alt="Team Menber"><div class="member-details"><h4 class="name">'+members[0].name+'</h4><p class="designation">'+members[0].job+'</p><p>'+members[0].text+'</p><div class="member-social-link"><a href="'+members[0].github+'" class="twitter-btn"><i class="fa fa-github"></i></a><a href="'+members[0].facebook+'" class="facebook-btn"><i class="fa fa-facebook"></i></a></div></div></div>')
    $('#member-1').html('<div class="inner-container"><img src="'+members[1].image+'" alt="Team Menber"><div class="member-details"><h4 class="name">'+members[1].name+'</h4><p class="designation">'+members[1].job+'</p><p>'+members[1].text+'</p><div class="member-social-link"><a href="'+members[1].github+'" class="twitter-btn"><i class="fa fa-github"></i></a><a href="'+members[1].facebook+'" class="facebook-btn"><i class="fa fa-facebook"></i></a></div></div></div>')
    $('#member-2').html('<div class="inner-container"><img src="'+members[2].image+'" alt="Team Menber"><div class="member-details"><h4 class="name">'+members[2].name+'</h4><p class="designation">'+members[2].job+'</p><p>'+members[2].text+'</p><div class="member-social-link"><a href="'+members[2].github+'" class="twitter-btn"><i class="fa fa-github"></i></a><a href="'+members[2].facebook+'" class="facebook-btn"><i class="fa fa-facebook"></i></a></div></div></div>')
    $('#member-3').html('<div class="inner-container"><img src="'+members[3].image+'" alt="Team Menber"><div class="member-details"><h4 class="name">'+members[3].name+'</h4><p class="designation">'+members[3].job+'</p><p>'+members[3].text+'</p><div class="member-social-link"><a href="'+members[3].github+'" class="twitter-btn"><i class="fa fa-github"></i></a><a href="'+members[3].facebook+'" class="facebook-btn"><i class="fa fa-facebook"></i></a></div></div></div>')
